...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: '📦',
      current: pathname === '/admin/productos',
    },
    {
      name: 'Órdenes',
      href: '/admin/ordenes',
      icon: '🛒',
      current: pathname === '/admin/ordenes',
    },
    {
      name: 'Reportes',
      href: '/admin/reportes',
      icon: '📈',
      current: pathname === '/admin/reportes',
    },
    {
      name: 'Configuración',
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button className="p-2 text-gray-400 hover:text-gray-500">⚙️</button>
                <button className="p-2 text-gray-400 hover:text-gray-500">🚪</button>
              </div>
            </div>
          </div>
