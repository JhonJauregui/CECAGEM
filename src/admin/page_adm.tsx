        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full flex items-center justify-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition">
                <span className="mr-2">👥</span> Nuevo Usuario
              </button>
              <button className="w-full flex items-center justify-center px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition">
                <span className="mr-2">📊</span> Ver Reportes
              </button>
              <button className="w-full flex items-center justify-center px-4 py-2 bg-yellow-600 text-white rounded-md hover:bg-yellow-700 transition">
                <span className="mr-2">📧</span> Enviar Newsletter
              </button>
            </div>
          </div>
